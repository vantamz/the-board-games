...
$(".fa-angle-left").click(function () {
 getPrevMonth();
 $(".main-calender").addClass("is-rotated-left");
 setTimeout(function () {
 $(".main-calender").removeClass("is-rotated-left");
 }, 195);
});

$(".fa-angle-right").click(function () {
 getNextMonth();
 $(".main-calender").addClass("is-rotated-right");
 setTimeout(function () {
 $(".main-calender").removeClass("is-rotated-right");
 }, 195);
});
